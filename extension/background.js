...
if (
  typeof RalgrumDetectors === "undefined" &&
...
function onMenuClicked(info, tab) {
  ...
  var entity =
    detectors && detectors.detectFromUrl ? detectors.detectFromUrl(raw) : null;
  if (!entity) {
    return;
  }
  var url =
    detectors && detectors.buildRalgrumUrl
      ? detectors.buildRalgrumUrl(entity)
      : null;
